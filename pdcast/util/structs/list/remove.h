...
namespace SinglyLinked {
    ...
    template <typename NodeType>
    inline void remove(SetView<NodeType>* view, PyObject* item) {
        // search for node
    ...
    template <typename NodeType>
    inline void remove(DictView<NodeType>* view, PyObject* item) {
        // search for node
    ...
    /* Remove an item from a set immediately before the specified sentinel value. */
    template <typename NodeType>
    inline void removebefore(SetView<NodeType>* view, PyObject* sentinel) {
        // search for node
    ...
    /* Remove an item from a dictionary immediately before the specified sentinel
    value. */
    template <typename NodeType>
    inline void removebefore(DictView<NodeType>* view, PyObject* sentinel) {
        // search for node
