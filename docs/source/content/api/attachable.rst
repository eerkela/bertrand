...
This adds the following attributes to the decorated function's interface, in
addition to any that are present on the function itself (see
...
.. warning::
    ...
    :class:`BoundMethod` and its decorated :class:`ExtensionFunc`.
