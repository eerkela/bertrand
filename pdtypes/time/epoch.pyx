...
def epoch_date(arg: str | datetime_like) -> dict[str, int]:
    ...
    See :func:`epoch()` for a list of available specifiers.

    Parameters
    ----------
    arg : str | datetime-like
        The epoch specifier to use.  Can be one of the shorthand specifiers
        listed in :func:`epoch()`, a direct datetime object, or a datetime
        string that can be parsed by `string_to_datetime()`.
    ...
    dict[str, int]
        ...
        This dictionary can be used as a **kwargs dict for
        :func:`date_to_days()`.
    ...
    See Also
    --------
    epoch : resolve epoch specifiers.

    Examples
    --------
    Epochs can be in any form accepted by :func:`epoch()`:
...
def epoch_ns(arg: str | datetime_like) -> int:
    ...
    arg : str | datetime-like
        The epoch specifier to use.  Can be one of the shorthand specifiers
        listed in :func:`epoch()`, a direct datetime object, or a datetime string
        that can be parsed by :func:`string_to_datetime()`.
