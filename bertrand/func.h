    ...
    */
    ...
    private:
        ...
        private:
            ...
            template <size_type... Is> requires (param.partial > 0 && param.kind.kwargs())
            ...
            // (3) keywords must be removed from their current location and bound to
            // `curr.partial_values`, which then gets forwarded.
