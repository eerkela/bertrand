...
namespace impl {
    ...
    public:
        struct __python__ : Object::cls<__python__, py_arg>, PyObject {
...
namespace impl {
    ...
    /* Implements the `__wrapped__` property for Python-level function descriptors. */
    template <typename T>
    PyObject* descriptor_wrapped(T* self, void*) noexcept {
        return Py_NewRef(ptr(self->func));
    }

    /* Implements the `__doc__` property for Python-level function descriptors. */
    template <typename T>
    PyObject* descriptor_doc(T* self, void*) noexcept {
        try {
            return release(getattr<"__doc__">(self->func));
        } catch (...) {
            Exception::to_python();
            return nullptr;
        }
    ...
    /* Implements the `__repr__` property for Python-level function descriptors. */
    template <typename T, static_str name>
    PyObject* descriptor_repr(T* self) noexcept {
        try {
            std::string str = "<" + name + "(" + repr(self->func) + ")>";
    ...
    /* Implements the `__call__` operator for Python-level function descriptors. */
    template <typename T, static_str name>
    PyObject* descriptor_call(
        T* self,
        PyObject* const* args,
        size_t nargsf,
        PyObject* kwnames
        ...
        try {
            if (kwnames) {
                PyErr_SetString(
                    PyExc_TypeError,
                    name + "() decorator does not accept keyword arguments"
                );
                return nullptr;
            }
            ...
            if (nargs > 1) {
                PyErr_SetString(
                    PyExc_TypeError,
                    name + "() decorator requires at most one positional "
                    "argument"
                );
                return nullptr;
            }
            ...
            static PyMethodDef inner {
                static_cast<const char*>(name + "_decorator"),
                reinterpret_cast<PyCFunction>(+[](
                    ...
                    try {
                        if (!PyType_Check(type)) {
                            PyErr_SetString(
                                PyExc_TypeError,
                                name + "() decorator requires a type as its "
                                "first argument"
                            );
                            return nullptr;
                        }
    ...
    /* Implements the `__call__` operator for Python-level property descriptors, which
    accept additional keyword-only arguments compared to function descriptors. */
    template <typename T, static_str name> requires (name == "property")
    PyObject* descriptor_call(
        T* self,
        PyObject* const* args,
        size_t nargsf,
        ...
        /// TODO: different rules for `property` vs. `classmethod` vs. `staticmethod`

    }

    /* Build a Python-level `bertrand.Intersection[]` type with the given name and
    type.  This is used to generate structural types using the `&`/`|` operators for
    function descriptors. */
    inline Object descriptor_to_intersection(const Object& name, const Object& obj) {
        Object bertrand = impl::import_bertrand;
    ...
    /* Implements the `&` operator for Python-level function descriptors. */
    template <typename T, typename Wrapper>
    PyObject* descriptor_and(PyObject* lhs, PyObject* rhs) noexcept {
        try {
            Type<Wrapper> type;
            if (PyType_IsSubtype(
                Py_TYPE(lhs),
                ...
                return PyNumber_And(
                    ptr(descriptor_to_intersection(
                        view(reinterpret_cast<T*>(lhs)->func)->name,
                        type
                    )),
                    rhs
                );
                ...
                return PyNumber_And(
                    lhs,
                    ptr(descriptor_to_intersection(
                        view(reinterpret_cast<T*>(rhs)->func)->name,
                        type
                    ))
                );
            }
    ...
    /* Implements the `|` operator for Python-level function descriptors. */
    template <typename T, typename Wrapper>
    PyObject* descriptor_or(PyObject* lhs, PyObject* rhs) noexcept {
        try {
            Type<Wrapper> type;
            if (PyType_IsSubtype(
                Py_TYPE(lhs),
    ...
    /* Implements `isinstance(obj, descriptor)` for Python-level function
    descriptors. */
    template <typename T>
    PyObject* descriptor_instancecheck(T* self, PyObject* obj) noexcept {
        try {
    ...
    /* Implements `issubclass(cls, descriptor)` for Python-level function
    descriptors. */
    template <typename T>
    PyObject* descriptor_subclasscheck(T* self, PyObject* cls) noexcept {
        try {
            if (!PyType_Check(cls)) {
                PyErr_SetString(
                    PyExc_TypeError,
...
namespace meta {
    ...
    namespace detail {
        template <typename F>
        inline constexpr bool extension_type<impl::Method<F>> = true;
        template <typename F>
        inline constexpr bool extension_type<impl::ClassMethod<F>> = true;
        template <typename F>
        inline constexpr bool extension_type<impl::StaticMethod<F>> = true;
        template <typename F>
        inline constexpr bool extension_type<impl::Property<F>> = true;
    }

}


template <meta::Descriptor Desc>
struct __getattr__<Desc, "__wrapped__"> : returns<
    typename std::remove_cvref_t<Desc>::function
> {
    static std::remove_cvref_t<Desc>::function operator()(auto&& self) {
        if constexpr (meta::Property<Desc>) {
            return view(self)->fget;
        } else {
...
template <meta::DescriptorType Desc>
struct __getattr__<Desc, "__wrapped__"> : returns<
    impl::Property<typename std::remove_cvref_t<Desc>::function(
        std::remove_cvref_t<Desc>
    )>
> {};
...
struct interface<impl::Method<F>> : impl::method_tag {
    ...
    __declspec(property(get = ___wrapped__))
    attr<impl::Method<F>, "__wrapped__"> __wrapped__;
    attr<impl::Method<F>, "__wrapped__"> ___wrapped__(this auto&& self) {
...
struct interface<Type<impl::Method<F>>> {
    ...
    __declspec(property(get = ___wrapped__))
    attr<Type<impl::Method<F>>, "__wrapped__"> __wrapped__;
    attr<Type<impl::Method<F>>, "__wrapped__"> ___wrapped__(this auto&& self) {
        return std::forward<decltype(self)>(self);
    }
};
...
struct interface<impl::ClassMethod<F>> : impl::classmethod_tag {
    ...
    __declspec(property(get = ___wrapped__))
    attr<impl::ClassMethod<F>, "__wrapped__"> __wrapped__;
    attr<impl::ClassMethod<F>, "__wrapped__"> ___wrapped__(this auto&& self) {
        return std::forward<decltype(self)>(self);
    }
};
template <typename F>
struct interface<Type<impl::ClassMethod<F>>> {
    ...
    __declspec(property(get = ___wrapped__))
    attr<Type<impl::ClassMethod<F>>, "__wrapped__"> __wrapped__;
    attr<Type<impl::ClassMethod<F>>, "__wrapped__"> ___wrapped__(this auto&& self) {
        return std::forward<decltype(self)>(self);
    }
};
...
struct interface<impl::StaticMethod<F>> : impl::staticmethod_tag {
    ...
    __declspec(property(get = ___wrapped__))
    attr<impl::StaticMethod<F>, "__wrapped__"> __wrapped__;
    attr<impl::StaticMethod<F>, "__wrapped__"> ___wrapped__(this auto&& self) {
        return std::forward<decltype(self)>(self);
    }
};
template <typename F>
struct interface<Type<impl::StaticMethod<F>>> {
    ...
    __declspec(property(get = ___wrapped__))
    attr<Type<impl::StaticMethod<F>>, "__wrapped__"> __wrapped__;
    attr<Type<impl::StaticMethod<F>>, "__wrapped__"> ___wrapped__(this auto&& self) {
        return std::forward<decltype(self)>(self);
    }
};


/// TODO: properties will have more attributes than just __wrapped__
...
namespace impl {
    ...
    struct Method : Object, interface<Method<F>> {
        struct __python__ : Object::cls<__python__, Method>, PyObject {
...
check.)doc";
            ...
            vectorcallfunc __vectorcall__ = reinterpret_cast<vectorcallfunc>(
                &descriptor_call<__python__, "method">
            );
            Function<F> func;
        ...
        private:
            ...
            inline static PyMethodDef methods[] = {
                {
                    "__instancecheck__",
                    reinterpret_cast<PyCFunction>(
                        &descriptor_instancecheck<__python__>
                    ),
                    METH_O,
                    nullptr
                },
                {
                    "__subclasscheck__",
                    reinterpret_cast<PyCFunction>(
                        &descriptor_subclasscheck<__python__>
                    ),
                    METH_O,
                    nullptr
                },
            ...
            inline static PyGetSetDef getset[] = {
                {
                    "__wrapped__",
                    reinterpret_cast<getter>(&descriptor_wrapped<__python__>),
                    nullptr,
                    nullptr,
                    nullptr
                },
                {
                    "__doc__",
                    reinterpret_cast<getter>(&descriptor_doc<__python__>),
                    nullptr,
                    nullptr,
                    nullptr,
                },
    ...
    struct ClassMethod : Object, interface<ClassMethod<F>> {
        struct __python__ : Object::cls<__python__, ClassMethod>, PyObject {
            static constexpr static_str __doc__ =
...
type check.)doc";
            ...
            vectorcallfunc __vectorcall__ = reinterpret_cast<vectorcallfunc>(
                &descriptor_call<__python__, "classmethod">
            );
            Function<F> func;
    ...
    struct StaticMethod : Object, interface<StaticMethod<F>> {
        struct __python__ : Object::cls<__python__, StaticMethod>, PyObject {
            static constexpr static_str __doc__ =
...
type check.)doc";
            ...
            vectorcallfunc __vectorcall__ = reinterpret_cast<vectorcallfunc>(
                &descriptor_call<__python__, "staticmethod">
            );
            Function<F> func;
    ...
    struct Property : Object, interface<Property<F>> {
        struct __python__ : Object::cls<__python__, Property>, PyObject {
            static constexpr static_str __doc__ =
                ...
                try {
                    ...
                    if (PyType_IsSubtype(
                        ...
                        return PyNumber_And(
                            ptr(descriptor_to_intersection(
                                view(
                                    reinterpret_cast<__python__*>(lhs)->func
                                )->name,
                                type
                            )),
                            rhs
                        ...
                        return PyNumber_And(
                            ...
                            ptr(descriptor_to_intersection(
                                view(
                                    reinterpret_cast<__python__*>(rhs)->func
                                )->name,
                                type
                            ))
                        );
...
/* Attach a function descriptor to a compatible type from C++. */
template <meta::Descriptor Desc, meta::Type T>
    requires (!(meta::is_const<T> || (
        (
            meta::Method<Desc> &&
            !meta::partially_callable<
                typename std::remove_cvref_t<Desc>::function,
                typename std::remove_cvref_t<T>::cls
            >
        ) || (
            meta::ClassMethod<Desc> &&
            !meta::partially_callable<
                typename std::remove_cvref_t<Desc>::function,
...
struct __call__<Desc, T>                                    : returns<T> {
    static decltype(auto) operator()(auto&& method, auto&& type) {
        if (PyObject_HasAttr(
            ptr(type),
            ptr(view(view(method)->func)->name)
        )) {
            throw TypeError(
                "type already has a " +
                repr(view(view(type)->func)->name) +
                " attribute"
            );
        }
        if constexpr (meta::Method<Desc>) {
            if (PyObject_SetAttr(
                ptr(type),
                ptr(view(view(method)->func)->name),
                ptr(view(method)->func)
            )) {
                Exception::from_python();
            }
        } else {
...
/* Attach a property descriptor to a compatible type from C++, with an optional
setter and/or deleter. */
template <meta::Descriptor Desc, meta::Type T, typename... Args>
    requires (
        meta::Property<Desc> &&
        !meta::is_const<T> &&
        meta::callable<
        ...
        meta::callable<
            void(
                typename Arg<"setter", Function<NoneType(
                    typename std::remove_cvref_t<Desc>::function::template at<0>,
                    typename std::remove_cvref_t<Desc>::function::Return
                )>>::kw::opt,
                typename Arg<"deleter", Function<NoneType(
                    typename std::remove_cvref_t<Desc>::function::template at<0>
                )>>::kw::opt
            ),
            Args...
...
struct __call__<Desc, T, Args...>                           : returns<T> {
    static decltype(auto) operator()(auto&& property, auto&& type, auto&&... args) {
        if (PyObject_HasAttr(
            ptr(type),
            ptr(view(view(property)->func)->name)
        )) {
            throw TypeError(
                "type already has a " +
                repr(view(view(type)->func)->name) +
        ...
        if (PyObject_SetAttr(
            ptr(type),
            ptr(view(view(property)->fget)->name),
            ptr(property)
        )) {
            Exception::from_python();
        }
...
static_assert(meta::Method<impl::Method<EllipsisType(Object)>>);


// static_assert(__call__<
//     impl::Method<EllipsisType(Object)>,
//     Type<Object>
// >::enable);
