                ...
                struct call<I, J, K> {  // forward source argument(s) or default value
                    ...
                    struct python {
                        static constexpr size_t n_partial_keywords = [] {
                            ...
                            /// values will then be promoted to keywords in order to
                            /// allow Python to insert the correct defaults, without
